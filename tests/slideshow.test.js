...
describe('slideshow.js', () => {
  ...
  beforeEach(() => {
    ...
    generatePlaylistForIndividualModel = slideshow.generatePlaylistForIndividualModel;
    ...
    pickAndDisplayNextGlobalMediaItem = slideshow.pickAndDisplayNextGlobalMediaItem;
    prepareMediaListForIndividualView = slideshow.prepareMediaListForIndividualView;
  ...
  describe('selectWeightedRandom', () => {
    ...
    it('should fallback to the full list if all items are excluded', () => {
        const items = [{ path: 'a', viewCount: 0 }, { path: 'b', viewCount: 1 }];
  ...
  describe('navigateMedia', () => {
    ...
    it('should pick a new item in global mode when navigating next at the end of the history', () => {
      ...
      state.globalMediaPoolForSelection = [{ path: 'a.jpg' }, { path: 'b.jpg' }];
  ...
  describe('prepareMediaListForIndividualView', () => {
    it('should prepare a media list for an individual view', () => {
      ...
      state.originalMediaFilesForIndividualView = [{ path: 'a.jpg' }, { path: 'b.jpg' }];
      prepareMediaListForIndividualView();
